            ...
            <form action="">
              <div className="gird-cols-1 grid items-center justify-center gap-4 md:grid-cols-3">
                ...
                <div className="mb-6 md:me-auto">
                  <button
                    type="submit"
                    className={`${styles.button} inline-block rounded px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-surface shadow-dark-3 shadow-black/30 transition duration-150 ease-in-out hover:shadow-dark-1 focus:shadow-dark-1 focus:outline-none focus:ring-0 active:shadow-1 dark:bg-neutral-700 dark:text-white`}
                    data-twe-ripple-init
                    data-twe-ripple-color="light"
                  >
                    Subscribe
